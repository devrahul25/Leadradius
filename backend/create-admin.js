...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var adminEmail, adminPassword, admin, teamEmail, teamPassword, team;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    adminEmail = 'admin@leadradius.io';
                ...
                case 2:
                    admin = _a.sent();
                    teamEmail = 'team@jaiveeru.co.in';
                    return [4 /*yield*/, bcrypt.hash('team123', 10)];
                case 3:
                    teamPassword = _a.sent();
                    return [4 /*yield*/, prisma.user.upsert({
